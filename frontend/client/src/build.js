  ...
  <body class="bg-slate-50 text-slate-900">
    ...
    <script>
      ...
      const headers = {
        ...
        'Authorization': localStorage.getItem('client_auth_token') ? ('Bearer ' + localStorage.getItem('client_auth_token')) : '',
      };
      ...
      q('client-add-lead').onclick = () => withLoading(q('client-add-lead'), async () => {
        ...
        try {
          const res = await fetch('/leads/leads', {
            method: 'POST',
            headers,
      ...
      q('client-start-warmup').onclick = () => withLoading(q('client-start-warmup'), async () => {
        ...
        try {
          const res = await fetch('/warmup/warmup/jobs', {
            method: 'POST',
            headers,
            body: JSON.stringify({
              tenant_id: tenantId,
